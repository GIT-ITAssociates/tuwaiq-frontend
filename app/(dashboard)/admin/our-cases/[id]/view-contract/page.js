...
import { getAdminContractByCaseId, updateCaseRequest } from "@/app/helpers/backend";
...
const ViewContractPage = ({ params }) => {
  ...
  const [data, getData] = useFetch(getAdminContractByCaseId);
  useEffect(() => {
    if (params?.id) {
