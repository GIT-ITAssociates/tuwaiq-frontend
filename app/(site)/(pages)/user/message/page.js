    ...
    const renderChatList = () => (
        ...
        >
            ...
            <div className="px-6 py-4 border-b bg-white">
               <input
  type="text"
  placeholder={currentLanguage === "Arabic" ? "البحث عن الدردشات..." : "Search chats..."}
  onChange={(e) => {
...
/>
                            ...
                            <div className='flex gap-4 items-center'>
                                ...
                                <div className="flex justify-between items-center mb-1">
                                    <h3 className="font-semibold text-gray-900 text-sm font-poppins capitalize line-clamp-1">
                                          {currentLanguage === "Arabic" ? "دعم الإدارة " : "Admin Support"}
                                    </h3>
                                </div>
                            </div>
                        </div>
  ...
  {currentLanguage === "Arabic"
    ? "انقر على بطاقة البريد الوارد لعرض الرسائل"
